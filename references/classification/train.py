...
# from torchvision.models.mobilenetv3 import MobileNet_V3_Smavi ll_Weights
import subprocess
...
def train_one_epoch(model,
    ...
    for image, target in metric_logger.log_every(data_loader, print_freq,
                                                 header):
        print(target)
        np.save(f'tensor_{epoch}.npy', image.numpy())
        np.save(f'tensor_target_{epoch}.npy', target.numpy())
        print(epoch)
...
def load_data(traindir, valdir, args):
    # Data loading code
    print("Loading data")
    resize_size, crop_size = (342,
                              299) if args.model == 'inception_v3' else (256,
                                                                         224)
    ...
    if args.cache_dataset and os.path.exists(cache_path):
        ...
        dataset = torchvision.datasets.ImageFolder(
            '/home/PJLAB/huyingfan/Desktop/openmmlab/mmclassification/data/data/imagenet-one/train',
    ...
    if args.cache_dataset and os.path.exists(cache_path):
        ...
        #     's3://openmmlab/datasets/classification/imagenet/val',
        #     's3://openmmlab/datasets/classification/imagenet/meta/val.txt',
        #     preprocessing,
        # )
...
def main(args):
    ...
    torch.save(model.state_dict(), 'vision_init.pth')
    model.to(device)
